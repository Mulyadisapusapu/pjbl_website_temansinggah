 // Custom Price Range Slider
      ...
      const budayaOptions = document.querySelectorAll("#budayaOptions .filter-option");
      ...
      document.getElementById("confirmBtn").addEventListener("click", function () {
        const selectedBudaya = document.querySelector("#budayaOptions .filter-option.active");
        const selectedJenis = document.querySelector("#jenisOptions .filter-option.active");
        ...
        const selectedFilters = {
          ...
          facilities: Array.from(document.querySelectorAll('input[type="checkbox"]:checked')).map(
            (el) => el.nextElementSibling.textContent
          ),
          rating: selectedRating ? selectedRating.querySelectorAll("span").length : null,
        };
